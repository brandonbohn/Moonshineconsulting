...
function SeniorPolicyBeat() {
  return (
    <section>
      <div className="header  text-white" style={{ textAlign: "center",  background: "#b8860b", padding: "50px", borderRadius: "8px",  marginTop: "100px",  marginRight: "150px", marginLeft: "150px",}}>
      ...
      <div className="text-white" style={{  background: "#000000", padding: "50px", borderRadius: "8px", marginBottom: "150px", marginLeft: "150px", marginRight: "150px" }}>
