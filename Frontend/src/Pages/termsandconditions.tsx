...
<h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>General Disclaimer</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>Earnings Disclaimer</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>No Doctor-Patient Relationship</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>Limitation of Liability</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>External Links</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>Intellectual Property</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>Changes to Terms</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>Medical Disclaimer</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
    ...
    <h4 style={{ fontSize: "27px", fontFamily: "Open Sans, Arial, sans-serif" }}>FTC Disclosure</h4>
  <p style={{ fontSize: "21px", fontFamily: "Georgia, serif" }}>
