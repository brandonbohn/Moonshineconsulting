...
function Voicesincareblogentry() {
  return (
    <div>
      ...
      />
      <div className="container" style={{ fontFamily: "sans-serif", minHeight: "100vh" }}>
        <style>{`
          .container {
            max-width: 1200px;
            margin: 0 auto;
        ...
        <div className="content mb-4 box text-dark" style={{ padding: "20px", fontSize: "20px", height: "100%", maxWidth: "100%", width: "100%", margin: "30px auto 0 auto", background: "#fff", borderRadius: "10px", textAlign: "left" }}>
          <p>
            ...
            <br />
            <br />
            Sometimes, comfort comes from small things—a warm blanket, a gentle touch, or even a simple therapy device. For example, red light therapy has become a gentle, non-invasive way to help ease discomfort and promote relaxation for some patients at home. These tools aren’t a replacement for medical care, but they can offer a bit of extra comfort when it’s needed most.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '32px' }}>
            {require('../../components/productgenerator.tsx').ProductComponent({ productid: 8 })}
          </div>
          <p>
            <br />
            <br />
